 ...
 * Original file: D:\\anh Ky\\frostwire-master\\android\\apollo\\src\\com\\andrew\\apollo\\IApolloService.aidl
 */
...
case TRANSACTION_isStopped:
{
data.enforceInterface(DESCRIPTOR);
boolean _result = this.isStopped();
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
...
@Override public boolean isStopped() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_isStopped, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
static final int TRANSACTION_isStopped = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
...
static final int TRANSACTION_shutdown = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
}
